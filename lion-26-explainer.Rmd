---
title: "LION 2026 paper on energy consumption of the Brave New Algorithm in a Few Visuals"
...
> This summary is part of the [Brave New Green Algorithm](https://jj.github.io/brave-new-green-algorithm) series, that investigates energy consumption of the Brave New Algorithm and, by extension, by other population-based optimization algorithms.
...
```
These `residual_seconds` (click on "Show") isolate operating-context and implementation influences, not affected by the algorithm parameters.
...
What you see is what you get: only two of the coefficients are significant, and at the 10% level; most changes that can be attributed to algorithm parameters are drowned by the operating context. This is what led us to improve the experimental protocol, something you can check in [this paper published at CEC](cec-2026-explainer.html).
...
Again, as you see in the table, only one of the coefficients (population size) explains variance at a 95% significance level, and one (evaluations) at a 90% level.
...
You can go ahead to [this expanded version of the paper, using the same data](lion-26-extended.html), which applies statistical models to understand what these measurements reveal about energy consumption (and what they don't).

## Questions? Suggestions?

You can use [GitHub issues](https://github.com/JJ/brave-new-green-algorithm/issues) to make them. PRs encouraged and welcome!
