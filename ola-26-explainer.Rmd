...
> Part of the additional content for the [OLA'26 paper *Best practices in measuring energy consumption in population-based metaheuristics*](https://jj.github.io/brave-new-green-algorithm/#ola26-conference)
...
|---|----------|--------------|
| 1 | Use 100 ms RAPL sampling | Reduces polling overhead incrementing precision; extends the measurement range |
| 2 | Beware of operating context drift | Measurements taken hours apart are not directly comparable |
