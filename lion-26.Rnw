...
account, %PABLO: Es relevante lo de Julia en el abstract? Si se usa algo
específico de optimización del lenguaje, decirlo aquí. JJ: Lo del overhead es
importante analyzing how different operator optimizations impact the performance
