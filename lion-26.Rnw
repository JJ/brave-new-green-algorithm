...
Since it is already well established that it is very difficult, or impossible, to know in advance how the energy profile for an implementation might change: %PABLO: Estos dos puntos me parecen raros aquí, no enlazan bien
