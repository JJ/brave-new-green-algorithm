...
%
<<lion.julia.1.11.8, echo=FALSE, warnings=FALSE, message=FALSE, fig.height=3, fig.pos="h!tb", fig.cap="Energy vs fitness difference to the optimum for all experiments for all parameter combinations; we compare here the optimized configuration vs. uniform random mutation in Julia 1.11.8.", fig.show='hold', out.width="50%">>=
