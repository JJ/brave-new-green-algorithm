...
- Use more sensor of operating conditions so that what causes energy consumption can be more easily modelled and the impact of algorithm parameters can be discerned.
