...
%
<<europar.initial.workload.model, echo=FALSE, message=FALSE,warning=FALSE, fig.cap="Energy consumption for the workload mesures, initial experiment.", fig.height=3.5, fig.pos="h!tb">>=
...
\bibliography{energy,ga-energy,GAs}
