...
<<europar.taskset, echo=FALSE, message=FALSE,warning=FALSE, fig.cap="Energy consumption for the workload experiment with taskset on die 1; (left) vs. (average) T, (right) vs. time", fig.pos="h!tb", fig.height=4, fig.show="hold", out.width="50%">>=
