...
<<europar.die2, echo=FALSE, message=FALSE,warning=FALSE, fig.cap="Energy consumption vs. Temperature for the workload (left), and Delta E vs. Delta R (right), taskset on die 2.", fig.height=3,fig.pos="h!tb", out.width="100%", fig.show="hold", out.width="50%">>=
