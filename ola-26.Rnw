...
<<ola.v11_8, echo=F, warning=F, fig.cap="Comparing Julia versions", fig.height=4, fig.pos="h!tb">>=
...
<<ola.no0, echo=F, fig.cap="Avoiding zero energy runs, comparison of results">>=
