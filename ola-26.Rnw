...
<<ola.deltas, echo=FALSE, warning=F, message=F>>=
...
compute_deltas( summary_baseline_data_evoapps, workload_data_evoapps )

workload_data_ola <- read.csv("data/ola-1.11.7-ola-14-Dec-13-02-30.csv")
compute_deltas( summary_baseline_data_ola, workload_data_ola )
