...
\methodstep{See further explanations on baseline variability: \protect\url{https://jj.github.io/brave-new-green-algorithm/cec-2026-explainer.html\#why-a-simple-baseline-is-not-enough}}
...
\methodstep{See further details on the issue with separated baseline and workload experiments: \protect\url{https://jj.github.io/brave-new-green-algorithm/cec-2026-explainer.html\#the-issue-with-separated-baseline-and-workload-experiments}}
