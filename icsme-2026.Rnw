...
<<icsme.balanced.workload, echo=FALSE, message=FALSE, warning=F, fig.cap="Workload energy consumption for the balanced temperature strategy", fig.env="figure*", fig.height=3 >>=
library(dplyr)
