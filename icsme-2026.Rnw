...
<<icsme.balanced, echo=FALSE, message=FALSE, fig.cap="Base energy consumption for processes placed on the cooler die. Please note we have clipped the y axis at 800", fig.env="figure*", fig.height=3 >>=
