...
Although this model is interesting for  undestanding the influence of the operating context, we are more interested in seeing how it affects the workload measures.
