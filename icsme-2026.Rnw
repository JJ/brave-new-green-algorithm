...
<<icsme.balanced.workload, echo=FALSE, message=FALSE, warning=F, fig.cap="Workload energy consumption for teh balanced temperature strategy", fig.env="figure*", fig.height=3 >>=
library(dplyr)
...
A model of the workload yields similar results as those found for the baseline.
