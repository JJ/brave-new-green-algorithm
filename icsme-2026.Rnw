...
Evolving software towards more energy-thrifty version requires a sound methodology that is able to differentiate the effects of the software under study from the operating context.
