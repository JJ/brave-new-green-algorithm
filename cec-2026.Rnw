...
Whether you want to present the reduction of energy consumption in algorithms implementation as an engineering requirement or as an ethical objective, the need of a methodology for comparing different configurations so that a decision can be reached is quite clear.
